            ...
            <div class="modal-body" id="contentShowCrewCertificate">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td><span id="code-main-group-in-component"></span> - <span id="main-group-in-component"></span></td>
                                <td><span id="code-group-in-component"></span> - <span id="name-group-in-component"></span></td>
                                <td><span id="code-sub-group-in-component"></span> - <span id="name-sub-group-in-component"></span></td>
                                <td><span id="code-unit-in-component"></span> - <span id="name-unit-in-component"></span></td>
                                <td><span id="code-component-in-component"></span> - <span id="name-component-in-component"></span></td>
                                <td><span id="created-at-in-component"></span></td>
                                <td><span id="created-by-in-component"></span></td>
                                <td><span id="updated-at-in-component"></span></td>
                                <td><span id="updated-by-in-component"></span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
