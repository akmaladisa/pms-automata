            ...
            <div class="modal-body px-4">
                ...
                <form method="POST" id="add_sub_group_form">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div>
                            <input id="code_sub_group_sub_group" placeholder="Sub Group Code" name="code_sub_group" required max="999" min="100" type="number" class="form-control" value="{{ old('code_sub_group') }}">
                        </div>
                        <div class=" mt-1">
            ...
            <div class="modal-body" id="contentShowCrewCertificate">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td><span id="code-main-group-in-sub-group"></span> - <span id="main-group-in-sub-group"></span></td>
                                <td><span id="code-group-in-sub-group"></span> - <span id="name-group-in-sub-group"></span></td>
                                <td><span id="code-sub-group-in-sub-group"></span> - <span id="name-sub-group-in-sub-group"></span></td>
                                <td><span id="created-at-in-sub-group"></span></td>
                                <td><span id="created-by-in-sub-group"></span></td>
                                <td><span id="updated-at-in-sub-group"></span></td>
                                <td><span id="updated-by-in-sub-group"></span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="modal-body px-4">
                ...
                <form method="POST" id="update_sub_group_form">
                    ...
                    <div class="form-group mb-4">
                        <label for="colFormLabel">Code</label>
                        <div>
                            <input readonly id="code_sub_group_sub_group_edit" placeholder="Sub Group Code" name="code_sub_group" required max="999" min="100" type="number" class="form-control" value="{{ old('code_sub_group') }}">
                        </div>
                        <div class=" mt-1">
                            <span class="badge badge-primary">
                                <small id="sh-text4" class="form-text mt-0">Max: 999 - Min: 100</small>
